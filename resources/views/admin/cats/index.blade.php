...
@section('main')
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button id="add-cart-modat" type="button" class="btn btn-primary btn-sm"
                                        data-toggle="modal" data-target="#new-cat-modal">
                                        Add Category
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="new-cat-modal" style="display: none;" aria-hidden="true">
    ...
    <div class="modal fade" id="edit-cat-modal" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
